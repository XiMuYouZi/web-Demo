<template>
  <div class="mv" v-if="$utils.isDefined(mvDetail.id)">
...
<script>
import { getMvDetail, getMvUrl, getSimiMv,  } from 'network/mv'
import {getArtists} from 'network/artist'
// import { hideMenuMixin } from "common-cpn/utils"
import Comments from 'business-cpn/comments'
import MvCard from 'business-cpn/mv-card'
