...
<script>
import { getLyric, getSimiSongs } from 'network/song'
import {  getSimiPlaylists } from 'network/playList'
import lyricParser from '@/utils/lrcparse'
import { debounce, isDefined, createSong, goMvWithCheck } from '@/utils'
...
@keyframes rotate {
  ...
  100% {
    transform: rotate(1turn);//转动一周，360°
  }
}
