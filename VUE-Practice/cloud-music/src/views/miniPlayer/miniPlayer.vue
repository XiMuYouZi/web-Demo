        ...
        <div class="content">
          ...
          <div class="time">
            <span class="played-time">
              {{ $utils.fromatDurationStr(currentTime * 1000) }}
            </span>
            <span class="split">/</span>
            <span class="total-time">
              {{ $utils.fromatDurationStr(currentSong.duration) }}
            </span>
          </div>
        </div>
      </template>
...
export default {
  ...
  methods: {
    ...
    onProgressChange(percent) {
      this.audio.currentTime = (this.currentSong.durationSecond / 1000) * percent
  ...
  computed: {
    ...
    playedPercent() {
      ...
      let percent = Math.min(this.currentTime  / (durationSecond / 1000), 1) || 0
      return percent
    },
    playControlIcon() {
